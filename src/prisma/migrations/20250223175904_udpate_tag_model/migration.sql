/*
  ...
  - You are about to drop the column `tagId` on the `Card` table. All the data in the column will be lost.
...
-- DropForeignKey
ALTER TABLE "tags" DROP CONSTRAINT "tags_cardId_fkey";

-- DropForeignKey
ALTER TABLE "tags" DROP CONSTRAINT "tags_userId_fkey";

-- AlterTable
ALTER TABLE "Card" DROP COLUMN "tagId";
